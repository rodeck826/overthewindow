...
public class KISA_SHA256 {
	...
	*/
	...
	{
		String temp = "rlawjddms1";
		byte[] tt = temp.getBytes();
		byte[] sv = new byte[32];
	//	KISA_SHA256.SHA256_Encrpyt(tt,tt.length,sv);
		System.out.println(new String(sv));
	   ...
	   /* for(int k=0; k<30; k++)
	    ...
	    System.out.print("\n");	  */
	// Encryption			    
	    SHA256_Encrpyt( tt, tt.length, sv );
		System.out.print("Ciphertext\t: ");
	    //for (int i=0; i<32; i++)	System.out.print(Integer.toHexString(0xff&sv[i]));
		//for (int i=0; i<32; i++)	System.out.print(toHex(sv[i]));
		System.out.println(toHex(sv));
	    System.out.print("\n\n");
	    
